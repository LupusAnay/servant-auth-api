...
type UsersAPI
   = "users" :> ReqBody '[ JSON] NewUser :> Post '[ JSON] UserId :<|> "users" :> Capture "id" UserId :> Get '[ JSON] User :<|> "users" :> Auth '[ JWT, Cookie] AuthSession :> Get '[ JSON] [User] :<|> "users" :> Auth '[ JWT, Cookie] AuthSession :> Capture "id" UserId :> ReqBody '[ JSON] NewUser :> PatchNoContent '[ JSON] NoContent :<|> "users" :> Auth '[ JWT, Cookie] AuthSession :> Capture "id" UserId :> DeleteNoContent '[ JSON] NoContent
